 ...
 * file '/cygdrive/c/intelFPGA_lite/17.1/MyModel/DE0_NANO_SOC_SPI_01/soc_system.sopcinfo'.
 */
...
/*
 * Macros for device 'spi_fifo_0', class 'spi_fifo'
 * The macros are prefixed with 'SPI_FIFO_0_'.
 * The prefix is the slave descriptor.
 */
#define SPI_FIFO_0_COMPONENT_TYPE spi_fifo
#define SPI_FIFO_0_COMPONENT_NAME spi_fifo_0
#define SPI_FIFO_0_BASE 0x0
#define SPI_FIFO_0_SPAN 4
#define SPI_FIFO_0_END 0x3

/*
 * Macros for device 'spi_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'SPI_PIO_'.
 * The prefix is the slave descriptor.
 */
#define SPI_PIO_COMPONENT_TYPE altera_avalon_pio
#define SPI_PIO_COMPONENT_NAME spi_pio
#define SPI_PIO_BASE 0x10
#define SPI_PIO_SPAN 16
#define SPI_PIO_END 0x1f
#define SPI_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define SPI_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define SPI_PIO_CAPTURE 0
#define SPI_PIO_DATA_WIDTH 8
#define SPI_PIO_DO_TEST_BENCH_WIRING 0
#define SPI_PIO_DRIVEN_SIM_VALUE 0
#define SPI_PIO_EDGE_TYPE NONE
#define SPI_PIO_FREQ 50000000
#define SPI_PIO_HAS_IN 1
#define SPI_PIO_HAS_OUT 1
#define SPI_PIO_HAS_TRI 0
#define SPI_PIO_IRQ_TYPE NONE
#define SPI_PIO_RESET_VALUE 0
...
#define SYSID_QSYS_TIMESTAMP 1516604963
